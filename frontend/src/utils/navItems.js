export const navItems = [
  ...
  // Add after the "Users" section:
  {
    ...
    items: [
      ...
      },{ key: "resident-management", label: "Residents", path: "/resident-management", icon: `<path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="23" y1="21" x2="23" y2="19"/><line x1="19" y1="21" x2="19" y2="17"/><path d="M16 3.13a4 4 0 010 7.75"/>` }
    ],
  },
];
