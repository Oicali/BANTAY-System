  ...
  return (
    <div className="cd-ai-error-overlay">
      <div className="cd-ai-error-modal">
        ...
        <p>
          Your selected range is only <strong>{weekCount} week{weekCount !== 1 ? "s" : ""}</strong> ({dayCount} days).
          <br />
          <br />
          Short ranges may result in low forecast confidence for some crime types.
          A minimum of <strong>34 weeks</strong> is recommended for reliable
          trend analysis and backtest validation.
        </p>
