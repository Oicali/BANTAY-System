...
const AddPatrolModal = ({
  mode,           // "add" | "edit"
  patrol,         // existing patrol data (edit mode)
  mobileUnits,
  availablePatrollers,
  geoJSONData,
  onClose,
  ...
  const buildGeoJSON = useCallback(() => {
    ...
    const selected = stops.map((s) => s.barangay).filter(Boolean);
    return {
      ...geoJSONData,
        ...
        <div className="apm-topbar">
          <div className="apm-topbar-fields">
            ...
            <div className="apm-field">
              ...
              <input type="text" name="patrol_name" value={form.patrol_name}
            ...
            <div className="apm-field">
              ...
              <select name="mobile_unit_id" value={form.mobile_unit_id}
          ...
          <div className="apm-map-panel">
            {hoveredBrgy && (
              <div className="apm-map-tooltip">
                ...
                {stops.some((s) => s.barangay === hoveredBrgy)
                  ? " — Already added"
                  : " — Click to add stop"}
              </div>
            )}
            ...
            <div className="apm-section">
              <div className="apm-section-title">
                ...
                {selectedPatrollerIds.length > 0 && (
                  <span className="apm-count"> ({selectedPatrollerIds.length})</span>
                )}
              </div>
              <input
                      ...
                      {stops.map((stop, idx) => {
                        ...
                        return (
                          <tr key={idx}>
                            ...
                            <td>
                              <button className="apm-remove" onClick={() => removeStop(idx)}>×</button>
                            </td>
                          </tr>
                        );
                      })}
