    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: "13px", color: "#6c757d", lineHeight: 1.6 }}>
          ...
          <strong style={{ color: "#212529" }}>{formatDate(date)}</strong>. Do
          you want to edit it?
        </div>
        <div
          style={{
...
const AfterPatrolModal = ({
  ...
  const handleFileSelect = (files) => {
    ...
    const remainingSlots = Math.max(
      0,
      10 - existingPhotos.length - images.length,
    );
    ...
    setImages((prev) =>
      [...prev, ...newFiles].slice(0, remainingSlots + prev.length),
    );
  };
    ...
    <div className="pd-modal">
      <div className="pd-modal-content">
        <div className="pd-modal-header">
          ...
          <span className="pd-modal-close" onClick={handleClose}>
            &times;
          </span>
        </div>
        ...
        <div className="pd-modal-body">
                      ...
                      onClick={() => {
                        ...
                        if (existingForDate) {
                          ...
                          setShown({
                            ...
                            numOfficials: !!(
                              rpt.num_officials != null &&
                              rpt.num_officials !== ""
                            ),
                            numGovt: !!(
                              rpt.num_govt_officials != null &&
                              rpt.num_govt_officials !== ""
                            ),
                            sector: true,
                            creditHours: true,
          ...
          {form ? (
            <>
              ...
              >
                Uncovered manholes, busted lights, uncollected garbage, fire
                hazard, missing bridge railings, etc.
              </div>
              <div className="pd-form-grid">
                <ToggleField
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                {existingPhotos.length + images.length >= 10 && (
                  ...
                  >
                    ...
                    Maximum of 10 photos reached. Remove existing photos to add
                    new ones.
                  </div>
                )}
            ...
            >
              ...
              >
                All available dates for this patrol already have a submitted
                report. Select a date tab above to view or edit it.
              </div>
            </div>
          )}
        </div>
        ...
        {showDateReportConfirm && (
          <DateReportConfirmDialog
            date={form?.date}
            onConfirm={() => {
              setShowDateReportConfirm(false);
              doSubmit();
            }}
    ...
    <div className="pd-modal">
      <div className="pd-modal-content" style={{ maxWidth: 680 }}>
        ...
        <div style={{ overflowY: "auto", flex: 1 }}>
          ...
          <div
            style={{ padding: "16px 32px 20px", background: "var(--gray-50)" }}
          >
            <div
              style={{
                background: "white",
            ...
            >
              ...
              >
                <ViewField
                  label="Date"
                  value={formatDate(report.patrol_date)}
                />
                <ViewField
                  label="Time"
                  value={
          ...
          >
            ...
            >
              ...
              >
                <ViewField
                  label="Mobile Unit Used"
                  value={report.sector_beat}
                />
                <ViewField
                  label="Patrolled MUST DOs"
                  value={report.must_dos}
                  full
                />
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <ViewField
                  label="Specific Instructions Received"
                  value={report.pre_deployment}
                  full
                />
                <ViewField
                  label="Action Taken"
                  value={report.action_pre_deployment}
                  full
                />
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <ViewField
                  label="Safety Concerns Observed"
                  value={report.safety_concerns}
                  full
                />
                <ViewField
                  label="Action Taken"
                  value={report.action_safety}
                  full
                />
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <ViewField
                  label="Other Public Safety Services Rendered"
                  value={report.other_services}
                  full
                />
                <ViewField
                  label="Visited Areas"
                  value={report.visited_areas}
                  full
                />
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                <ViewField
                  label="Name of Persons Visited / Local Officials"
                  value={report.persons_visited}
                  full
                />
                <ViewField
                  label="No. of Officials Visited"
                  value={
                    report.num_officials != null
                      ? String(report.num_officials)
                      : null
                  }
                />
                <ViewField
                  ...
                  value={
                    report.num_govt_officials != null
                      ? String(report.num_govt_officials)
                      : null
                  }
                />
              </div>
          ...
          <div
            style={{ padding: "16px 32px 28px", background: "var(--gray-50)" }}
          >
            {photos.length === 0 ? (
              <div
                style={{
      ...
      <div className="pd-modal-content" style={{ maxWidth: 720 }}>
        ...
        >
          {patrolDates.map((d) => {
            ...
            const isFuture =
              getPatrolStatus(patrol) === "active" && pillDate > todayDate();
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ fontWeight: 700, color: "var(--gray-600)" }}
                        >
                          {r.submitted_by_name ||
                            r.officer_name ||
                    ...
                    >
                      {[
                        ...
                        {
                          label: "Gov't Officials",
                          value:
                            r.num_govt_officials != null
                              ? String(r.num_govt_officials)
                              : null,
                        },
                        {
                          label: "Signatures",
...
const AfterPatrol = () => {
        ...
        if (images.length > 0) {
          try {
            ...
            if (!photoData.success) {
              photoWarning =
                photoData.message ||
                "Report saved, but photos failed to upload. Please try attaching them again.";
            }
          } catch (photoErr) {
  ...
  const handleOpenAfterReport = (patrol, myShift) => {
    ...
    fetch(`${API_BASE}/patrol/patrols/${patrol.patrol_id}/after-reports/mine`, {
      ...
      .then((data) => {
        setSelectedReport((prev) =>
          prev
            ? {
                ...prev,
                existingReports: data.success ? data.data || [] : [],
                existingReportsLoaded: true,
              }
            : prev,
        );
      ...
      .catch(() => {
        setSelectedReport((prev) =>
          prev ? { ...prev, existingReportsLoaded: true } : prev,
        );
      });
  };
